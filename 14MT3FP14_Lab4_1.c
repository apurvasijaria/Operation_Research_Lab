...
printf("FUNCTIONS WITH <= WILL PROVIDE SLACK VARIABLES BUT THOSE WITH >= WILL NOT.\n");
printf("HENCE TO MAKE A UNIT MATRIX, WE MUST TAKE HELP OF ARTIFICIAL VARIABLES. THIS\n");
...
double cj[20],basis[20],c[20],colmat[20],tab[20][20];
bk=0;
printf("\n\nTAKE \"M\" AS A BIT SMALLER THAN ANY SMALLEST NUMBER IN THE EQUATIONS...\n\n\n");
printf("\nTOTAL NUMBER OF >= EQUALITIES IN SUBJECTIVE FUNCTIONS:\n");
scanf("%d", &g);
printf("\nTOTAL NUMBER OF <= EQUALITIES IN SUBJECTIVE FUNCTIONS:\n");
scanf("%d", &l);
